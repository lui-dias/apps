...
export type CheckoutFragment = {
    ...
    | Array<
      {
        ...
        customization?: {
          ...
          values?:
            | Array<
              { cost: any; name?: string | null; value?: string | null } | null
            >
            | null;
        } | null;
      } | null
  ...
  selectedPaymentMethod?: {
    ...
    installments?:
      | Array<
        | { adjustment: number; number: number; total: number; value: number }
        | null
      >
      | null;
    selectedInstallment?: {
    ...
    | Array<
      {
        ...
        adjustments?:
          | Array<
            { name?: string | null; type?: string | null; value: any } | null
          >
          | null;
        delivery?: {
          cost: any;
          ...
          | Array<
            {
              ...
              adjustments?:
                ...
                | null;
              attributes?:
                | Array<{ name?: string | null; value?: string | null } | null>
                | null;
            } | null
          >
          | null;
...
export type ProductFragment = {
  ...
  attributes?:
    | Array<{ value?: string | null; name?: string | null } | null>
    | null;
  productCategories?:
    | Array<
      {
  ...
  informations?:
    | Array<
      | { title?: string | null; value?: string | null; type?: string | null }
      | null
    >
    | null;
  images?:
    | Array<
      { url?: string | null; fileName?: string | null; print: boolean } | null
    >
    | null;
  prices?: {
      ...
      | Array<
        {
          ...
          installments?:
            | Array<
              | { discount: boolean; fees: boolean; number: number; value: any }
              | null
            >
            | null;
        } | null
...
export type SingleProductPartFragment = {
  ...
  informations?:
    ...
    | null;
  breadcrumbs?:
    | Array<{ text?: string | null; link?: string | null } | null>
    | null;
  images?:
    | Array<
      { url?: string | null; fileName?: string | null; print: boolean } | null
  ...
  attributeSelections?: {
    ...
    matrix?: {
      ...
      data?:
        | Array<
          Array<
            { available: boolean; productVariantId: any; stock: any } | null
          > | null
        >
        | null;
      row?: {
        ...
        name?: string | null;
        values?:
          | Array<{ value?: string | null; printUrl?: string | null } | null>
          | null;
      } | null;
    } | null;
    selectedVariant?: {
...
export type CheckoutCloseFieldsFragment = {
  checkoutId: any;
  completed: boolean;
  orders?:
    | Array<
...
export type SelectPaymentFragment = {
  checkoutId: any;
  total: any;
  subtotal: any;
  selectedPaymentMethod?: {
    ...
    | Array<
      {
        ...
        periods?:
          | Array<
            { end?: string | null; id: any; start?: string | null } | null
          >
          | null;
      } | null
    >
...
export type CustomerFragment = {
  ...
  informationGroups?:
    | Array<{ exibitionName?: string | null; name?: string | null } | null>
    | null;
};
      ...
      selectedVariant?: {
        ...
        prices?: {
          ...
          priceTables?:
            ...
            | null;
          wholesalePrices?:
            | Array<{ price: any; quantity: number } | null>
            | null;
          bestInstallment?: {
            discount: boolean;
            displayName?: string | null;
      ...
      | Array<
        {
          ...
          customization?: {
            ...
            values?:
              | Array<
                | { cost: any; name?: string | null; value?: string | null }
                | null
              >
              | null;
          } | null;
...
export type SearchQuery = {
  result?: {
    ...
    aggregations?: {
      ...
      minimumPrice: any;
      priceRanges?:
        | Array<{ quantity: number; range?: string | null } | null>
        | null;
      filters?:
        | Array<
          {
            ...
            origin?: string | null;
            values?:
              | Array<{ quantity: number; name?: string | null } | null>
              | null;
          } | null
        >
        | null;
    ...
    breadcrumbs?:
      | Array<{ link?: string | null; text?: string | null } | null>
      | null;
    ...
    | Array<
      {
        ...
        images?:
          | Array<
            | { url?: string | null; fileName?: string | null; print: boolean }
            | null
          >
          | null;
        prices?: {
    ...
    | Array<
      {
        ...
        deliverySchedules?:
          ...
          | null;
        products?:
          | Array<{ productVariantId: number; value: number } | null>
          | null;
      } | null
    >
    | null;
...
export type GetWislistQuery = {
  customer?: {
    wishlist?: {
      products?:
        | Array<{ productId?: any | null; productName?: string | null } | null>
        | null;
    } | null;
  } | null;
};
        ...
        | Array<
          {
            ...
            origin?: string | null;
            values?:
              | Array<{ name?: string | null; quantity: number } | null>
              | null;
          } | null
        >
        | null;
...
export type CustomerAuthenticatedLoginMutation = {
...
export type CustomerAccessTokenRenewMutation = {
  customerAccessTokenRenew?: { token?: string | null; validUntil: any } | null;
};
...
export type CustomerAddressRemoveMutation = {
  customerAddressRemove?: { isSuccess: boolean } | null;
};
...
export type CreateCheckoutMutationVariables = Exact<{
  products:
    | Array<InputMaybe<CheckoutProductItemInput>>
    | InputMaybe<CheckoutProductItemInput>;
}>;

export type CreateCheckoutMutation = {
  createCheckout?: { checkoutId: any } | null;
};
...
export type CheckoutCustomerAssociateMutation = {
  checkoutCustomerAssociate?: { checkoutId: any } | null;
};
...
export type PaymentMethodsQuery = {
  paymentMethods?:
    | Array<
      | { id?: string | null; name?: string | null; imageUrl?: string | null }
      | null
    >
    | null;
};
...
export type GetCheckoutCouponQuery = {
  checkout?: { coupon?: string | null } | null;
};
...
export type CheckoutAddressAssociateMutation = {
...
export type CheckoutSelectShippingQuoteMutation = {
...
export type CheckoutSelectPaymentMethodMutation = {
...
export type CalculatePricesQueryVariables = Exact<{
  partnerAccessToken: Scalars["String"]["input"];
  products:
    | Array<InputMaybe<CalculatePricesProductsInput>>
    | InputMaybe<CalculatePricesProductsInput>;
}>;
...
export type CheckoutSelectInstallmentMutation = {
...
export type CheckoutCloneMutation = {
  checkoutClone?: { checkoutId: any } | null;
};
...
export type GetProductCustomizationsQuery = {
  product?: {
    productName?: string | null;
    productId?: any | null;
    productVariantId?: any | null;
...
export type CustomerSocialLoginGoogleMutation = {
